...
// native 获取设备信息
export const nativeGetDeviceInfo = () =>
  nativeSDKPromisify('device.getDeviceInfo');
...
// native获取用户信息
export const nativeGetUserInfo = () =>
  nativeSDKPromisify('account.getUserInfo');
...
// 获取用户收听时长
export const nativeGetUserListenData = () =>
  nativeSDKPromisify('busi.getUserListenData');

// 加密数据
export const nativeEncrypt = (data: {
  type: 'rsa';
